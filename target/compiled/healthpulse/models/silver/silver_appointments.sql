...
from healthpulse_s3_db.bronze_schema.raw_appointments

    where appointment_id not in (select appointment_id from HEALTHPULSE_S3_DB.silver_schema.silver_appointments)
